...
public class TileEntityTestFurnace extends TileEntityLockable implements ISidedInventory, ITickable {
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.test_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                test_furnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
    ...
    /**
     * Time To Cook Something Lower = Faster, 200 Default.
     */
